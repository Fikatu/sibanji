...
function endRound() {
    ...
    if (currentPlayerHealth <= 0 && hasBonusLife) {
        ...
        alert("Mai ai o viata bonus! Sa nu ma dezamagesti!");
    }

    if (currentMonsterHealth <= 0 && currentPlayerHealth > 0) {
        alert("Ai Castigat! Toata lumea il bate pe sibanji! HAHAHAHA");
        writeToLog(
            LOG_EVENT_GAME_OVER,
            "Ai castigat",
            currentMonsterHealth,
        ...
        alert("Ai pierdut! Cum sa pierzi in fata lui sibanji? :))")
        writeToLog(
            LOG_EVENT_GAME_OVER,
            "Sibanji a castigat!",
            currentMonsterHealth,
